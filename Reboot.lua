...
local function EJAEWWB_fake_script() -- TextButton.LocalScript 
...
coroutine.wrap(EJAEWWB_fake_script)()
local function DGGE_fake_script() -- TextButton_2.LocalScript 
...
coroutine.wrap(DGGE_fake_script)()
local function SZZSNA_fake_script() -- Frame.LocalScript 
...
coroutine.wrap(SZZSNA_fake_script)()
